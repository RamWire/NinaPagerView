...
- (void)viewDidLoad {
     ...
     */
    NinaPagerView *ninaPagerView = [[NinaPagerView alloc] initWithNinaPagerStyle:NinaPagerStyleBottomLine WithTitles:titleArray WithVCs:detailVCsArray WithColorArrays:colorArray];
    /**
